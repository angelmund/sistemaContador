    ...
    <div class="card mt-5">
        <div class="card-body">
            <div class="text-center mb-3">
                ...
                <button class="btn btn-warning"><i class='bx bxs-user-check'></i></i>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge rounded-pill"
                                style="background-color: {{ $usuario->rol == 1 ? 'green' : 'red' }}; color: white;">
                                {{ $usuario->rol == 1 ? 'Administrador' : 'Inactivo' }}
                            </span>
                        </td>
                        <td>
                            <span class="badge rounded-pill"
                                style="background-color: {{ $usuario->rol == 1 ? 'green' : 'red' }}; color: white;">
                                {{ $usuario->rol == 1 ? 'Activo' : 'Inactivo' }}
                            </span>
                        </td>
                        <td>
                            
                            <button type="button" class="btn btn-primary abrir-inscripcion" data-bs-toggle="modal"
                                data-bs-target="#EditModal{{ $usuario->id}}" data-remote="{{$usuario->id}}"><i
