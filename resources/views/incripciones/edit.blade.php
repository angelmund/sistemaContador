...
<div class="modal fade" id="EditModal{{$inscripcion->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            ...
            <form id="formedit-incripcion" action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn_actualizar" data-modal-id="{{$inscripcion->id}}"><i class="fas fa-save btn_save"></i> Actualizar inscripción</button>
