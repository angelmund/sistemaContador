    ...
    <div class="card mt-5">
        <div class="card-body">
            <div class="text-center mb-3">
                <a href="{{route('inscripciones.form')}}" type="button" class="btn btn-primary"><i class="fas fa-plus"></i> Nueva Inscripción</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary abrir-inscripcion" data-bs-toggle="modal"
                                data-bs-target="#EditModal{{ $inscripcion->id}}" data-remote="{{$inscripcion->id}}"><i
                                    class="fas fa-eye"></i></button>
                            <a type="button" href="{{route('pagos.alta', $inscripcion->id)}}" class="btn btn-success"><i class="fas fa-dollar-sign"></i></a>
